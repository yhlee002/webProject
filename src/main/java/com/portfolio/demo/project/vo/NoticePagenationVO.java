...
public class NoticePagenationVO {
    ...
    public NoticePagenationVO() {
        this.currentPageNo = 1;
    }

    public NoticePagenationVO(int totalBoardCnt, int currentPageNo, List<BoardNotice> boardNoticeList, int boardsPerPage, int start, int end) {
