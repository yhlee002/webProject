...
public class CommentMovPagenationVO {
    ...
    private int totalCommentCnt; // 총 게시글 개수
    ...
    public CommentMovPagenationVO(int totalCommentCnt, int currentPageNo, List<CommentMov> commentMovsList, int commentsPerPage, int start, int end) {
    ...
    public int getTotalPageCnt() {
        if (totalCommentCnt == 0) {
            ...
            totalPageCnt = totalCommentCnt / commentsPerPage;
