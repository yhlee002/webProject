...
public class CommentImpPagenationVO {
    ...
    public CommentImpPagenationVO() {
        this.currentPageNo = 1;
    }

    public CommentImpPagenationVO(Long totalCommentCnt, int currentPageNo, List<CommentImpVO> commentImpsList, int commentsPerPage, int start, int end) {
        this.totalCommentCnt = totalCommentCnt;
        this.currentPageNo = currentPageNo;
        this.commentImpsList = commentImpsList;
